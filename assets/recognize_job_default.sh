...
#SBATCH -D /lnet/work/people/stankov/parczech/slurm-logs/debug
...
python /lnet/work/people/stankov/parczech/scripts/recognize.py \
links=$links overwrite_recognized=True output_folder=/lnet/troja/work/people/stankov/parczech4speechmodeling
